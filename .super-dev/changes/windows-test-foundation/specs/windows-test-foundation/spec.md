...
- [ ] AC1: 唯一临时用户目录在 Windows 上可证明生效
- [ ] AC2: 两个高风险测试文件不再接触真实用户位置
- [ ] AC3: 完整宿主用户级接入面自动进入摘要
- [ ] AC4: 主目录外 `CODEX_HOME` 被覆盖
- [ ] AC5: Windows 路径同一性和逃逸检查通过
- [ ] AC6: 历史和当前失败登记可追溯且不相加
- [ ] AC7: Windows 3.10、3.11、3.12 证据可取得
- [ ] AC8: 默认产品行为保持兼容
