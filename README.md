...
[打开](https://github.com/mixyoung/super-dev/blob/main/docs/assets/architecture/system-overview.html)原图 · [查看](https://github.com/mixyoung/super-dev/blob/main/docs/assets/architecture/system-overview.archify.json)图源代码
...
[打开](https://github.com/mixyoung/super-dev/blob/main/docs/assets/architecture/pipeline-12-phase.html)原图 · [查看](https://github.com/mixyoung/super-dev/blob/main/docs/assets/architecture/pipeline-12-phase.archify.json)图源代码
...
[打开](https://github.com/mixyoung/super-dev/blob/main/docs/assets/architecture/module-topology.html)原图 · [查看](https://github.com/mixyoung/super-dev/blob/main/docs/assets/architecture/module-topology.archify.json)图源代码
...
Super Dev 按 `CLI / IDE / 桌面助手` 统一接入，默认采用项目优先注入。完整宿主清单、触发方式、重启要求与接入面说明已移至：

- [统一接入宿主矩阵](docs/HOST_MATRIX.md)
